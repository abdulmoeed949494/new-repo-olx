...
const User = () => {
    ...
    const { products, userCart, setUserCart, UserPageOpen, UserincreaseQuantity, UserdecreaseQuantity, cart, setCart, wishlist, setWishList, increaseWishListQuantity, decreaseWishListQuantity, favoriteFunc } = useContext(StateContext) 
        ...
        userCart.map((item) => (
            <div key={item.id} className="grid grid-cols-2 w-[1500px] h-[600px]">
                ...
                <div>
                    ...
                    <div className="flex text-2xl w-96 mt-8">
                        Quantity
                    ...
                    <div className="flex content-between items-center gap-5 mt-20 w-60 h-20">
