...
const Login = () => {
  const { isLogin, setIsLogin, userCart, input, setInput, error, setError, success, setSuccess, Successtimer, Errortimer, login, handleOrderPlacement } = useContext(StateContext);
